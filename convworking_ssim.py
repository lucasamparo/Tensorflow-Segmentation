...
class Network:
    ...
    def batchmsssim(self, predicted, targets):
        return ssim.tf_ms_ssim(predicted, targets)
    ...
    def __init__(self, layers=None, per_image_standardization=False, batch_norm=True, skip_connections=True):
        ...
        self.train_op = tf.train.AdamOptimizer(learning_rate=0.001).minimize(1 - self.cost)
...
def train():
    ...
    dataset = Dataset(folder='data{}_{}'.format(128, 128), include_hair=False,
    ...
    with tf.Session() as sess:
        ...
        for epoch_i in range(n_epochs):
            ...
            for batch_i in range(dataset.num_batches_in_epoch()):
                ...
                print('{}/{}, epoch: {}, ms_ssim rank: {}, batch time: {}'.format(batch_num,
